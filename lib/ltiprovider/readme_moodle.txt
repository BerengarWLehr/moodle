...
One chang has been made whithout accompanying pull request as the library is archived:
* Configuration variable $CFG->wwwroot is to determine the servername for OAuth
